...
plt.legend()
plt.grid(True)
tikzplotlib.save("error_rates_iopLoguni.tikz")
for format in save_formats:
    filename = f'error_rates_iopLoguni.{format}'
    plt.savefig(filename, format=format, bbox_inches='tight', dpi=300)
plt.show()
...
plt.legend()
plt.grid(True)
tikzplotlib.save("accuracies_iopLoguni.tikz")
for format in save_formats:
    filename = f'accuracies_iopLoguni.{format}'
    plt.savefig(filename, format=format, bbox_inches='tight', dpi=300)
plt.show()
